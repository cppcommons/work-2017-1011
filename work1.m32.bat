...
set MSYS2_PKGS=%MSYS2_PKGS%,  mingw-w64-i686-clang
set MSYS2_PKGS=%MSYS2_PKGS%,  gdb
::,mingw-w64-i686-gdb,mingw-w64-i686-emacs
...
::set MSYS2_PKGS=%MSYS2_PKGS%,  mingw32/mingw-w64-i686-ruby
::set MSYS2_PKGS=%MSYS2_PKGS%,  mingw32/mingw-w64-i686-python2
